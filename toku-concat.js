...
var TokuStep, TokuOperationType, TokuEventResult, __extends = this && this.__extends || function () {
  ...
  return t.prototype.handleEvent = function (t) {
    ...
    return t.id = this.settings.iframeId, t.setAttribute("allowFullscreen", ""), t.src = "https://pabssandbox.trytoku.com/".concat(this.portalHost).concat(this.path).concat(this.formatQueryParams()), t
      ...
      return __generator(this, function (t) {
        switch (t.label) {
          case 0:
            ...
            t.label = 1;
          case 1:
            return t.trys.push([1, 4, , 5]), [4, fetch("https://pabssandbox.trytoku.com/customer-id/".concat(r), {
              method: "GET",
              mode: "cors",
              cache: "no-cache",

...
var TokuStep, TokuOperationType, TokuEventResult, __extends = this && this.__extends || function () {
  ...
  return t.prototype.handleEvent = function (t) {
    ...
    return t.id = this.settings.iframeId, t.textContent = "Pagar aqui", t.href = "https://pabssandbox.trytoku.com/".concat(this.portalHost).concat(this.path).concat(this.formatQueryParams()), t
